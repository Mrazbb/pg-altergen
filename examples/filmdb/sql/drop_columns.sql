...
-- This file was generated by pg-altergen v3.1.2
-- 2025-05-01T15:12:51.532Z
...
SELECT * FROM drop_not_included_columns_for_all(ARRAY[('public','tbl_user',ARRAY['id','username','email','fullname','isactive','dtcreated','dtupdated','dtremoved'])::schema_table_inclusion,('public','tbl_review',ARRAY['id','userid','movieid','reviewtext','rating','dtcreated'])::schema_table_inclusion,('public','tbl_movie',ARRAY['id','title','description','rating','images','dtreleased','dtcreated','dtupdated','dtremoved'])::schema_table_inclusion,('public','tbl_config',ARRAY['id','type','value'])::schema_table_inclusion,('altergen','tbl_migrations',ARRAY['id','queryid','checksum','query','comment','dtexecuted'])::schema_table_inclusion]::schema_table_inclusion[]); 
 -- This file was generated by pg-altergen v3.1.2
-- 2025-05-01T15:12:51.532Z
